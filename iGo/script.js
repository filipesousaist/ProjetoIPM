...
var screens =
{
	...
	function()
	{
		...
		{
			info_img = "<img class='info_icon' src='img/infoicon.png' onclick='changeInfoScreen(\""+ l +"\");'>";
			places_element.innerHTML += "<li class='iGuide_place_frame'>" + "<div class='iGuide_place'>" + locations[l].title + "</div>" + info_img + "</li>";
		}
	},
...
function changeInfoScreen(location_name)
{
	...
	document.getElementById("iGuide_info_icon").src = location_type_img[location.type];
...
function turn_off_on()
{
	...
	{
		document.getElementById("iGo_logo").style.animation = "fade 1.5s";
		setTimeout(function()
		{
			power = 1;
